...
import com.learning.agrovision.databinding.FragmentYeildPridictionBinding
import java.time.LocalDate


class YeildPridiction : Fragment() {

    var dialog: Dialog?=null
    lateinit var binding:FragmentYeildPridictionBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        binding= FragmentYeildPridictionBinding.inflate(layoutInflater)
    ...
    override fun onCreateView(
        ...
        viewModel.observe_yeild().observe(requireActivity(), Observer { res->
            ...
            if(res.isSuccessful)
            {
                ...
                binding.ans.text= "The production in  tone is  ${res.body()!!.prediction?.get(0)!!}"
            }
            else
            {
            }
